...
<head>
    ...
    <title>Edit Project Initiatives</title>
                        ...
                        <form action="{{ route('initiatives.update', $initiatives->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                name="project_category" value="{{ old('project_category') }}" required>
                                    <option value="{{ $initiatives->project_category }}">{{ $initiatives->project_category }}</option>
                            ...
                            <div class="form-group">
                                ...
                                name="year" value="{{ old('year', $initiatives->year) }}" required>
                                    <option value="{{ $initiatives->year }}">{{ $initiatives->year }}</option>
                                    <option selected disabled>-- Selected --</option>
                            ...
                            <div class="form-group">
                                ...
                                name="priority" value="{{ old('priority', $initiatives->priority) }}" required>
                                    <option value="{{ $initiatives->priority }}">{{ $initiatives->priority }}</option>
                                    <option selected disabled>-- Selected --</option>
                            ...
                            <div class="form-group">
                                ...
                                name="status" value="{{ old('status', $initiatives->status) }}" required>
                                    <option value="{{ $initiatives->status }}">{{ $initiatives->status }}</option>
                                    <option selected disabled>-- Selected --</option>
                            ...
                            <div hidden class="form-group">
                                ...
                                name="assignment" value="{{ old('assignment', $initiatives->priority) }}" required>
                                    <option>--- Selected ---</option>
                                    <option value="Accept" {{ $initiatives->assignment }}>Accept</option>
                                    <option value="Dissmiss" {{ $initiatives->assignment }}>Dissmiss</option>
                                </select>
                                <!-- error message untuk title -->
                                @error('assignment')
                                    <div class="invalid-feedback">
